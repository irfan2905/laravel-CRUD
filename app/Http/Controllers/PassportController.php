...
class PassportController extends Controller
{
    ...
    public function index()
    {
        ...
        //var_dump($passports);exit;
        return view("passport.index")->with('passports', $passports);
    }
    ...
    public function store(Request $request)
    {
        ...
        $passport->phone_number=$request->get('number');
    ...
    {   
        ...
        $passport->phone_number=$request->number;
    ...
    {
        $passport = \App\Passport::find($request->id);
        $passport->delete();
